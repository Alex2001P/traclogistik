            ...
            <section class="flex-1 my-5  w-4/5 ml-auto mr-auto bg-white p-5 rounded-xl">
                <form method="POST" wire:submit.prevent="created">
                    ...
                    <div>
                        ...
                        <x-input id="name" class="block mt-1 w-full" type="text" wire:model="name" name="name" :value="old('name')" required autofocus autocomplete="name" />
                    </div>
                    ...
                    <div>
                        <x-label for="transportista_id" value="{{ __('Transportista') }}" />
